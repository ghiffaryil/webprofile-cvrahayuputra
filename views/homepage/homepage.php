<div id="main-carousel" class="carousel slide hero-slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/slider/cvrp1.jpg" alt="Hero Slide" style="width: 100%; height: 600px; object-fit: cover;">
            <!--Slide Image-->
            ...
            <div class="container">
                <div class="carousel-caption">
                    <small class="animated fadeIn">
                        <font style="color:white">CALL US TODAY</font>
                    </small>
                    <div class="phone animated lightSpeedIn">
                        <font style="color:white">1-800-1234-567</font>
                    </div>
        ...
        <div class="item">
            <img src="assets/img/slider/harga-kayu-palet.jpg" alt="Hero Slide" style="width: 100%; height: 600px; object-fit: cover;">
            <!--Slide Image-->
            <div class="overlay" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.85);"></div>
            <!-- Overlay with opacity -->
...
<!-- About-us-wrap -->
<section class="about-us-wrap section-padding" style="padding-top: 55px;">
    <div class="container">
        <div class="row">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 col-sm-12">
                <div id="service-carousel" class="carousel slide" style="padding-top: 55px;">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                    <div class="service-content">
                                        ...
                                        <div class="service-thumb">
                                            <img class="img-responsive" src="assets/img/service1.png" alt="image" />
                                        </div>
                                        <p>Progressively architect prospective imperatives through competitive communities. Professionally productize user strategic theme areas.</p>
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <div class="service-content">
                                        ...
                                        <div class="service-thumb">
                                            <img class="img-responsive" src="assets/img/service2.png" alt="image" />
                                        </div>
                                        <p>Progressively architect prospective imperatives through competitive communities. Professionally productize user strategic theme areas.</p>
                                        <a class="btn btn-primary" href="#">Continue reading<i class="fa fa-long-arrow-right"></i></a>
                                    </div><!-- /.service-content -->
                    ...
                    <div class="owl-carousel fleet-carousel">
                        <div class="item">
                            <div class="owl-item-thumb">
                                <img src="assets/img/fleet/p1.png" alt="">
                                <div class="owl-item-overlay"></div>
                                <a class="img-link" href="img/fleet/p1.png"><img src="assets/img/zoomin.png" alt="+" /></a>
                            </div><!-- owl-item-thumb -->
                        ...
                        <div class="item">
                            <div class="owl-item-thumb">
                                <img src="assets/img/fleet/p2.png" alt="">
                                <div class="owl-item-overlay"></div>
                                <a class="img-link" href="img/fleet/p2.png"><img src="assets/img/zoomin.png" alt="+" /></a>
                            </div><!-- owl-item-thumb -->
                            <div class="owl-tem-content">
                        ...
                        <div class="item">
                            <div class="owl-item-thumb">
                                <img src="assets/img/fleet/p3.png" alt="">
                                <div class="owl-item-overlay"></div>
                                <a class="img-link" href="img/fleet/p3.png"><img src="assets/img/zoomin.png" alt="+" /></a>
                            </div><!-- owl-item-thumb -->
                            <div class="owl-tem-content">
                        ...
                        <div class="item">
                            <div class="owl-item-thumb">
                                <img src="assets/img/fleet/p4.png" alt="">
                                <div class="owl-item-overlay"></div>
                                <a class="img-link" href="img/fleet/p3.png"><img src="assets/img/zoomin.png" alt="+" /></a>
                            </div><!-- owl-item-thumb -->
                            <div class="owl-tem-content">
        ...
        <div class="carousel-inner">
                ...
                <div class="media">
                    <div class="media-left">
                        <div class="item-left-thumb">
                            <img class="img-responsive" src="assets/img/client/client1.png" alt="client">
                            ...
                            <div class="author-info row row-flex row-flex-wrap">
                                ...
                                <div class="col-xs-5">
                                    <img src="assets/img/client/client-org1.png" alt="img">
                                </div>
                            </div>
                        </div>
                    </div><!-- /.col -->
            ...
            <div class="item">
                <div class="media">
                    <div class="media-left">
                        <div class="item-left-thumb">
                            <img class="img-responsive" src="assets/img/client/client2.png" alt="client">
