...
if(isset($_POST['submit_simpan'])){
	if($cek_required == "Sukses"){
		...
		$form_field = array("Id_Blog_Artikel","Id_Pengguna","Jenis_Artikel","Judul_Artikel","Isi_Artikel","Tag_Artikel","Status_Artikel","Waktu_Terakhir_Update","Waktu_Simpan_Data","Status");

		$form_value = array(NULL,"$u_Id_User","$_POST[Jenis_Artikel]","$_POST[Judul_Artikel]","$_POST[Isi_Artikel]","$_POST[Tag_Artikel]","$_POST[Status_Artikel]","$Waktu_Sekarang","$Waktu_Sekarang","Aktif");
		...
		if($result['Status'] == "Sukses"){
			...
			if ($_FILES['Foto_Artikel']['size'] <> 0 && $_FILES['Foto_Artikel']['error'] == 0){
				...
				$nama_file_upload = $a_hash->hash_nama_file($Id_Auto_Increment,"_Foto_Artikel")."_".$Id_Auto_Increment."_Foto_Artikel";
...
if(isset($_POST['submit_update']))
{
	if($cek_required == "Sukses")
	{
		$form_field = array("Jenis_Artikel","Judul_Artikel","Isi_Artikel","Tag_Artikel","Status_Artikel","Waktu_Terakhir_Update");

		$form_value = array("$_POST[Jenis_Artikel]","$_POST[Judul_Artikel]","$_POST[Isi_Artikel]","$_POST[Tag_Artikel]","$_POST[Status_Artikel]","$Waktu_Sekarang");
		...
		if($result['Status'] == "Sukses"){
			...
			if ($_FILES['Foto_Artikel']['size'] <> 0 && $_FILES['Foto_Artikel']['error'] == 0){
				...
				$path_file_upload = $_FILES['Foto_Artikel']['name'];
				$ext_file_upload = pathinfo($path_file_upload, PATHINFO_EXTENSION);
				$nama_file_upload = $a_hash->hash_nama_file($Get_Id_Primary,"_Foto_Artikel")."_".$Get_Id_Primary."_Foto_Artikel";
				$folder_penyimpanan_file_upload = "../media/artikel/";
				$tipe_file_yang_diizikan_file_upload = array("png","gif","jpg","jpeg");
				$maksimum_ukuran_file_upload = 3000000;
...
$count_field_where = array("Status","Jenis_Artikel");
$count_criteria_where = array("=","=");
$count_connector_where = array("AND","");

//DATA AKTIF
$count_value_where = array("Aktif","Artikel");
...
//DATA TERARSIP
$count_value_where = array("Terarsip","Artikel");
...
$count_value_where = array("Terhapus","Artikel");
										...
										<div class="row">
											...
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="Judul_Artikel" value="<?php if((isset($_POST['submit_simpan'])) OR (isset($_POST['submit_update']))){ echo $_POST['Judul_Artikel']; }elseif(isset($_GET['edit'])){echo $edit['Judul_Artikel'];} ?>">
													</div>
												</div>
											</div>
											...
											<div class="col-md-12" style="display:none;">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" readonly name="Jenis_Artikel" value="<?php if((isset($_POST['submit_simpan'])) OR (isset($_POST['submit_update']))){ echo $_POST['Judul_Artikel']; }elseif(isset($_GET['edit'])){echo $edit['Judul_Artikel'];}else{echo "Artikel"; } ?>" class="form-control">
													</div>
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="form-group row">
													<label class="col-lg-3 control-label">Isi Artikel</label>
													<div class="col-lg-9">
														<textarea id="editor1" class="form-control" rows="10" name="Isi_Artikel"><?php if((isset($_POST['submit_simpan'])) OR (isset($_POST['submit_update']))){ echo $_POST['Isi_Artikel']; }elseif(isset($_GET['edit'])){echo $edit['Isi_Artikel'];} ?></textarea>
													</div>
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="form-group row">
													<label class="col-lg-3 control-label">Tag Artikel</label>
													<div class="col-lg-9">
											...
											<div class="col-md-12">
												<div class="form-group row">
													<label class="col-lg-3 control-label">Status Artikel</label>
													<div class="col-lg-9">
											...
											<div class="form-group row">
												<label class="col-lg-3 control-label">Poster Artikel</label>
												<div class="col-lg-9">

													<?php 
													if (isset($_GET['edit'])) {
														if($edit['Foto_Artikel'] <> ""){
														?>
														<img src="../media/artikel/<?php echo $edit['Foto_Artikel']?>?time=<?php echo $Waktu_Sekarang?>" style="width: 300px; height: auto">
														<br><br>
								...
								<div class="table-responsive">
									<table id="example1" class="table table-bordered" style="width:100%">
										...
										<tbody>
											...
											$search_field_where = array("Status","Jenis_Artikel");
											$search_criteria_where = array("=","=");
											$search_value_where = array("$filter_status","Artikel");
											...
											if($result['Status'] == "Sukses"){
												...
												foreach($data_hasil as $data){ $nomor++; ?>
													<tr>
														...
														<td>
															<a href="<?php echo $kehalaman ?>&edit&id=<?php echo $a_hash->encode($data["Id_Blog_Artikel"],$_GET['menu']); ?>">
														...
														<td>
															...
															if($data['Foto_Artikel'] <> ""){
																?>
																<img src="../media/artikel/<?php echo $data['Foto_Artikel']?>?time=<?php echo $Waktu_Sekarang?>" style="width: 100px; height: auto">
																<?php
															}
															?>
														</td>
