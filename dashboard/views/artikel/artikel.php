										...
										<div class="row">
											...
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="Judul_Artikel" value="<?php if ((isset($_POST['submit_simpan'])) or (isset($_POST['submit_update']))) {
																																echo $_POST['Judul_Artikel'];
																															} elseif (isset($_GET['edit'])) {
																																echo $edit['Judul_Artikel'];
																															} ?>">
													</div>
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<textarea id="editor1" class="form-control" rows="10" name="Isi_Artikel"><?php if ((isset($_POST['submit_simpan'])) or (isset($_POST['submit_update']))) {
																																		echo $_POST['Isi_Artikel'];
																																	} elseif (isset($_GET['edit'])) {
																																		echo $edit['Isi_Artikel'];
																																	} ?></textarea>
													</div>
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" data-role="tagsinput" style="width: 100% !important" class="form-control" name="Tag_Artikel" value="<?php if ((isset($_POST['submit_simpan'])) or (isset($_POST['submit_update']))) {
																																													echo $_POST['Tag_Artikel'];
																																												} elseif (isset($_GET['edit'])) {
																																													echo $edit['Tag_Artikel'];
																																												} ?>">
														<br>
													...
													<div class="col-lg-9">
														<select required class="form-select" name="Status_Artikel">
															<option value="<?php if ((isset($_POST['submit_simpan'])) or (isset($_POST['submit_update']))) {
																				echo $_POST['Status_Artikel'];
																			} elseif (isset($_GET['edit'])) {
																				echo $edit['Status_Artikel'];
