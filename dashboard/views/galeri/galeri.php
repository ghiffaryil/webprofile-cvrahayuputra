...
if(isset($_POST['submit_update'])){
	if($cek_required == "Sukses"){
		...
		$form_field = array("Judul_Galeri","Keterangan","Waktu_Terakhir_Update");
		$form_value = array("$_POST[Judul_Galeri]","$_POST[Keterangan]","$Waktu_Sekarang");
										...
										<div class="row">
											...
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="Judul_Galeri" value="<?php if((isset($_POST['submit_simpan'])) OR (isset($_POST['submit_update']))){ echo $_POST['Judul_Galeri']; }elseif(isset($_GET['edit'])){echo $edit['Judul_Galeri'];} ?>">
													</div>
												</div>
											</div>
